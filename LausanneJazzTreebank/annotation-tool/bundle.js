...
(function(exports) {
  ...
  //-----------
  var Click = (function () {
      function Click(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Click.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Click(value0, value1, value2);
              };
          };
      };
      return Click;
  ...
  var DelButton = (function () {
      function DelButton(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DelButton.create = function (value0) {
          return function (value1) {
              return new DelButton(value0, value1);
          };
      };
      return DelButton;
  })();
  ...
  var LabelChange = (function () {
      function LabelChange(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      LabelChange.create = function (value0) {
          return function (value1) {
              return new LabelChange(value0, value1);
          };
      };
      return LabelChange;
  })();
  var treeString = function (v) {
      if (v instanceof Leaf) {
          return v.value0 + " ";
      };
      if (v instanceof Binary) {
          return "[." + (v.value0 + (" " + (treeString(v.value1) + (treeString(v.value2) + "] "))));
      };
      throw new Error("Failed pattern match at Component line 26, column 1 - line 26, column 36: " + [ v.constructor.name ]);
  };
  var style = Halogen_HTML_Properties.prop(Halogen_HTML_Core.stringIsProp)("style");
  ...
  var buttonsFromString = function (str) {
      var labels = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_String_Regex.split(Data_String_Regex_Unsafe.unsafeRegex(" |\x0a|\x09")(Data_String_Regex_Flags.noFlags))(str));
      var xs = Data_List.range(0)(Data_List.length(labels) - 1 | 0);
      return Data_List.zipWith(Data_Function.apply)(Control_Apply.apply(Data_List_Types.applyList)(Control_Apply.apply(Data_List_Types.applyList)(Data_List.zipWith(makeButton)(labels)(xs))(Control_Applicative.pure(Data_List_Types.applicativeList)(0)))(Control_Applicative.pure(Data_List_Types.applicativeList)(1)))(Data_Functor.map(Data_List_Types.functorList)(Leaf.create)(labels));
  };
  var initState = function (leafString) {
      var buttons = buttonsFromString(leafString);
      return {
          storedButton: Data_Maybe.Nothing.value,
          buttons: buttons,
          tree: new Leaf("... wait for it ..."),
          leafString: leafString
      };
  };
  var $$eval = function (v) {
      if (v instanceof Click && v.value0 instanceof Data_Maybe.Nothing) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $36.storedButton = new Data_Maybe.Just(v.value1);
              return $36;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
          });
      };
      if (v instanceof Click && v.value0 instanceof Data_Maybe.Just) {
          var newTree = (function () {
              var $42 = v.value0.value0.left <= v.value1.left;
              if ($42) {
                  return new Binary(v.value1.label, v.value0.value0.tree, v.value1.tree);
              };
              return new Binary(v.value1.label, v.value1.tree, v.value0.value0.tree);
          })();
          var newButton = {
              label: v.value1.label,
              left: Data_Ord.min(Data_Ord.ordInt)(v.value0.value0.left)(v.value1.left),
              top: Data_Ord.max(Data_Ord.ordInt)(v.value0.value0.top)(v.value1.top) + 1 | 0,
              width: v.value0.value0.width + v.value1.width | 0,
              tree: newTree
          };
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $44.storedButton = Data_Maybe.Nothing.value;
                  $44.buttons = new Data_List_Types.Cons(newButton, v1);
                  $44.tree = newTree;
                  return $44;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
      ...
      if (v instanceof LabelChange) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(initState(v.value0)))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      if (v instanceof DelButton) {
          var f = function (a) {
              return function (c) {
                  return a.label === c.label && (a.left === c.left && (a.top === c.top && a.width === c.width));
              };
          };
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.buttons;
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $54.storedButton = Data_Maybe.Nothing.value;
                  $54.buttons = Data_List.deleteBy(f)(v.value0)(v1);
                  return $54;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
      ...
      throw new Error("Failed pattern match at Component line 78, column 1 - line 78, column 53: " + [ v.constructor.name ]);
  };
  var buttonCSS = function (b) {
      return "position: absolute;" + ("background-color:PapayaWhip;" + ("height:" + (Data_Show.show(Data_Show.showInt)(20) + ("px;" + ("width:" + (Data_Show.show(Data_Show.showInt)(b.width * 50 | 0) + ("px;" + ("left:" + (Data_Show.show(Data_Show.showInt)(b.left * 50 | 0) + ("px;" + ("top:" + (Data_Show.show(Data_Show.showInt)(b.top * 20 | 0) + "px;"))))))))))));
  };
  var renderButton = function (mb) {
      return function (b) {
          return Halogen_HTML_Elements.button([ style(buttonCSS(b)), Halogen_HTML_Properties.draggable(true), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Click.create(mb)(b))), Halogen_HTML_Events.onDragEnter(Halogen_HTML_Events.input_(DelButton.create(b))) ])([ Halogen_HTML_Core.text(b.label) ]);
      };
  };
  var renderState = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(state.leafString), style("width:500px;"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(LabelChange.create)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(treeString(state.tree)) ]), Halogen_HTML_Elements.div([ style("position:relative;") ])(Data_Array.fromFoldable(Data_List_Types.foldableList)(Control_Apply.apply(Data_List_Types.applyList)(Data_Functor.map(Data_List_Types.functorList)(renderButton)(Control_Applicative.pure(Data_List_Types.applicativeList)(state.storedButton)))(state.buttons))) ]);
  };

  //-----------------
  // App Component --
  //-----------------
  var appComponent = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](initState("C Dm G7 C")),
      render: renderState,
      "eval": $$eval,
  ...
  exports["buttonsFromString"] = buttonsFromString;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Component.appComponent)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();