...
/* package ParseTreeStrings-1.0 */
#define VERSION_ParseTreeStrings "1.0"
#define MIN_VERSION_ParseTreeStrings(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "ParseTreeStrings-1.0"

#define CURRENT_PACKAGE_KEY "ParseTreeStrings-1.0"
